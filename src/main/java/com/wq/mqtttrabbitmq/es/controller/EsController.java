package com.wq.mqtttrabbitmq.es.controller;

import com.alibaba.fastjson.JSONObject;
import com.wq.mqtttrabbitmq.es.EsClient;
import com.wq.mqtttrabbitmq.es.bean.EsModel;
import com.wq.mqtttrabbitmq.es.bean.EsPage;
...
public class EsController {
    ...
    public String insertJson() {
        ...
        jsonObject.put("id", IDUtils.getId());
        jsonObject.put("age", new Random(100).nextInt());
        jsonObject.put("name", "Json-" + new Random(100).nextInt());
        jsonObject.put("date", DateFormatUtils.format(new Date(),"yyyy-MM-dd HH:mm:ss"));
        String id = EsClient.addData(jsonObject, indexName, esType, jsonObject.getString("id"));
        return id;
    }
    ...
    public String insertModel() {
        ...
        esModel.setId(IDUtils.getId());
        esModel.setName("EsModel-" + new Random(100).nextInt());
        esModel.setAge(new Random(100).nextInt());
        esModel.setDate(DateFormatUtils.format(new Date(),"yyyy-MM-dd HH:mm:ss"));
     ...
     * @param num
     */
    @RequestMapping("batchInsert/{num}")
    public void batchInsert(@PathVariable Integer num){
    ...
    public String delete(String id) {
        if (StringUtils.isNotBlank(id)) {
            EsClient.deleteDataById(indexName, esType, id);
            return "删除id=" + id;
        } else {
            return "id为空";
        }
    ...
    public String update(String id) {
        if (StringUtils.isNotBlank(id)) {
            ...
            jsonObject.put("date", DateFormatUtils.format(new Date(),"yyyy-MM-dd HH:mm:ss"));
            EsClient.updateDataById(jsonObject, indexName, esType, id);
            return "id=" + id;
        } else {
            return "id为空";
        }
    ...
    public String getData(String id) {
        if (StringUtils.isNotBlank(id)) {
            Map<String, Object> map = EsClient.searchDataById(indexName, esType, id, null);
    ...
    public String queryMatchData() {
        ...
        List<Map<String, Object>> list = EsClient.
    ...
    public String queryWildcardData() {
        ...
        List<Map<String, Object>> list = EsClient.searchListData(indexName, esType, queryBuilder, 10, null, null, null);
        return JSONObject.toJSONString(list);
    }
    ...
    public String queryIntRangeData() {
        ...
        boolQuery.must(QueryBuilders.rangeQuery("age").from(21)
                .to(25));
        List<Map<String, Object>> list = EsClient.searchListData(indexName, esType, boolQuery, 10, null, null, null);
        return JSONObject.toJSONString(list);
    }
    ...
    public String queryPage(String startPage, String pageSize) {
        if (StringUtils.isNotBlank(startPage) && StringUtils.isNotBlank(pageSize)) {
            ...
            boolQuery.must(QueryBuilders.rangeQuery("date").from("2018-04-25T08:33:44.840Z")
                    .to("2019-04-25T10:03:08.081Z"));
            EsPage list = EsClient.searchDataPage(indexName, esType, Integer.parseInt(startPage), Integer.parseInt(pageSize), boolQuery, null, null, null);
            return JSONObject.toJSONString(list);
        } else {
